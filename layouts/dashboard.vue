...
<template>
    <div
        class="w-full h-2 fixed bg-red-600 sm:bg-orange-600 md:bg-yellow-600 lg:bg-green-600 xl:bg-blue-600 2xl:bg-purple-600">
    </div>
    <div class="w-full h-screen flex flex-col bg-base-300">
        <header class="p-4 flex fixed flex-col w-full z-30 items-end">
            ...
            <ul class="menu bg-base-200 w-40 rounded-box mt-3 p-2 shadow-md" v-show="isMenuOpen">
                <li>
        ...
        <nav class="flex z-20 fixed items-center m-2 h-full" v-show="isNavOpen">
            <ul class="menu bg-base-200 p-2 rounded-box shadow-md">
                <li>
                ...
                <li>
                    <NuxtLink to="/dashboard/metrics">
                        ...
                        <p class="hidden md:inline">Metrics</p>
                    </NuxtLink>
                </li>
                <li>
        ...
        <div class="w-full h-full px-10 pt-24 pb-10">
            <slot />
        </div>
    </div>
</template>